...
def _write_stress_metric(produced, elapsed, target_mps, avg_latency_ms=0.0):
    """
    ...
    try:
        ...
        cluster.shutdown()
        print(f"[stress-test] summary persisted: produced={produced} achieved={achieved}msg/s")
